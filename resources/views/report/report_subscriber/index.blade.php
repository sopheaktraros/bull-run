...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{ route('report_subscriber') }}">Report Subscriber</a></div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <form id="frm-report-subscriber" action="" style="width:100%">
                            <table width="100%">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td">
                                        <input type="text" id="contact" name="contact" class="form-control" autocomplete="off" placeholder="Contact number">
                                    </td>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="report-subscriber-table" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Subscriber</th>
