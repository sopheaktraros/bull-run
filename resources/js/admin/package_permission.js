$("#btnSearchPackagePermission").click(function(){
    let id = $("#package").val();
    let url = "/package_permission/response/"+id;
    let str = '';
    $.ajax({
        type:'GET',
        url : url,
        ...
        success:function(data){
            ...
            $.each(json.Menu, function(i,e){
                ...
                if(e.menu_control != "" && e.menu_order == "0"){
                    str += `
                        <div class="accordion">
                    ...
                    $.each(e.Submenu, function(j,k){
                        str += `
                                ...
                                <div class="accordion-subbody">
                                    <label class="custom-switch mt-2">
                                        <span class="custom-switch-description">${k.name_en}</span>
